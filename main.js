...
let current_users = ["admin", "Eric", "Ali", "Fatima", "hamza"];
let new_users = ["admin", "hamza", "Aliza", "Haseeb", "Noor"];
let current_users_lower = current_users.map(user => user.toLocaleUpperCase());
